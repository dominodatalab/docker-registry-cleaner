...
FROM cgr.dev/dominodatalab.com/python:3.14.7-dev AS dev
WORKDIR /app
...
FROM cgr.dev/dominodatalab.com/skopeo:1.24.0 AS skopeo

# 3) Final runtime: minimal Python + app + skopeo
FROM cgr.dev/dominodatalab.com/python:3.14.7
WORKDIR /app
