...
class TestBaseDeletionScript:
    ...
    def test_initialization_with_defaults(self, mocker, mock_config_manager, mock_skopeo_client,
                                          mock_health_checker, mock_checkpoint_manager):
    ...
    def test_initialization_with_overrides(self, mocker, mock_config_manager, mock_skopeo_client,
                                           mock_health_checker, mock_checkpoint_manager):
        ...
        script = ConcreteDeletionScript(
            registry_url='custom-registry:5000',
    ...
    def test_confirm_deletion_force_mode(self, mocker, mock_config_manager, mock_skopeo_client,
                                         mock_health_checker, mock_checkpoint_manager):
    ...
    def test_confirm_deletion_user_accepts(self, mocker, mock_config_manager, mock_skopeo_client,
                                           mock_health_checker, mock_checkpoint_manager):
    ...
    def test_confirm_deletion_user_rejects(self, mocker, mock_config_manager, mock_skopeo_client,
                                           mock_health_checker, mock_checkpoint_manager):
    ...
    def test_enable_registry_deletion_success(self, mocker, mock_config_manager, mock_skopeo_client,
                                              mock_health_checker, mock_checkpoint_manager):
    ...
    def test_disable_registry_deletion_success(self, mocker, mock_config_manager, mock_skopeo_client,
                                               mock_health_checker, mock_checkpoint_manager):
    ...
    def test_run_health_checks_all_pass(self, mocker, mock_config_manager, mock_skopeo_client,
                                        mock_health_checker, mock_checkpoint_manager):
    ...
    def test_run_health_checks_required_fails(self, mocker, mock_config_manager, mock_skopeo_client,
                                              mock_health_checker, mock_checkpoint_manager):
...
class TestArchivedTagsFinder:
    ...
    def test_fetch_archived_object_ids_environments(self, mocker, mock_archived_tags_deps):
        ...
        rev_id = ObjectId()
        mock_db['environment_revisions'].find.return_value = [
...
class TestFilterClonedDependencies:
    ...
    def test_filter_cloned_dependency_in_set(self, mocker, mock_archived_tags_deps):
        ...
        mock_db['environment_revisions'].find_one.return_value = {
            '_id': cloned_rev_id,
...
class TestInUseEnvironmentDetection:
    ...
    def test_finds_workspace_references(self, mocker, mock_archived_tags_deps):
        ...
        mock_db['workspace'].find.return_value = [
            {'_id': ObjectId(), 'configTemplate': {'environmentId': env_id}}
        ]
