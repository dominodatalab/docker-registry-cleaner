...
class TestUsageDetection:
    ...
    def test_analyze_image_usage_basic(self):
        ...
        image_analysis = {"layer1": {"tags": ["tag1", "tag2"], "size": 1000000}}

        mongodb_reports = {
            "runs": [{"environment_docker_tag": "tag1"}],
            "workspaces": [],
            "models": [],
            "scheduler_jobs": [],
            "projects": [],
        ...
        analysis = deleter.analyze_image_usage(image_analysis, mongodb_reports=mongodb_reports, recent_days=None)
    ...
    def test_analyze_image_usage_with_age_filtering(self):
        ...
        analysis = deleter.analyze_image_usage(image_analysis, mongodb_reports=mongodb_reports, recent_days=30)
    ...
    def test_analyze_image_usage_keeps_config_usage(self):
        ...
        mongodb_reports = {
            "runs": [{"environment_docker_tag": "project-tag", "last_used": old_date}],  # Very old
            "workspaces": [],
            "models": [],
            "scheduler_jobs": [],
            "projects": [{"environment_docker_tag": "project-tag"}],  # But in project config
            "organizations": [],
            "app_versions": [],
        }

        analysis = deleter.analyze_image_usage(
            image_analysis, mongodb_reports=mongodb_reports, recent_days=30  # Should filter out old runs
        )
    ...
    def test_get_most_recent_usage_date_empty(self):
        ...
        usage_info = {"runs": [], "workspaces": [], "models": []}
    ...
    def test_get_most_recent_usage_date_multiple_sources(self):
        ...
        usage_info = {
            ...
            "workspaces": [
                {"workspace_last_change": (now - timedelta(days=5)).isoformat().replace("+00:00", "Z")}
            ],  # Most recent
            "models": [],
        }
