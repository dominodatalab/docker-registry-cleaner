...
class TestSharedLayerCalculation:
    ...
    def _add_image_with_layers(self, image_id: str, layers: list):
        ...
        for order_index, (layer_id, size_bytes) in enumerate(layers):
            ...
            if layer_id in self.analyzer.layers:
                ...
                self.analyzer.layers[layer_id] = {"size_bytes": size_bytes, "ref_count": 1}

            # Add image-to-layer mapping
            self.analyzer.image_layers.append({"image_id": image_id, "layer_id": layer_id, "order_index": order_index})
    ...
    def test_single_image_no_shared_layers(self):
        ...
        self._add_image_with_layers("environment:tag1", [("layer1", 1000), ("layer2", 2000), ("layer3", 3000)])
    ...
    def test_multiple_images_no_shared_layers(self):
        ...
        self._add_image_with_layers("environment:tag1", [("layer1", 1000), ("layer2", 2000)])
        self._add_image_with_layers("environment:tag2", [("layer3", 3000), ("layer4", 4000)])
    ...
    def test_shared_base_layer(self):
        ...
        self._add_image_with_layers("environment:tag1", [("base_layer", 5000), ("unique_layer1", 1000)])  # Shared
        self._add_image_with_layers(
            "environment:tag2", [("base_layer", 5000), ("unique_layer2", 2000)]  # Shared (same layer_id)
        )
    ...
    def test_shared_layer_multiple_images(self):
        ...
        self._add_image_with_layers("environment:tag1", [("base_layer", 5000), ("unique1", 1000)])
        self._add_image_with_layers("environment:tag2", [("base_layer", 5000), ("unique2", 2000)])
        self._add_image_with_layers("environment:tag3", [("base_layer", 5000), ("unique3", 3000)])
    ...
    def test_partially_shared_layers(self):
        ...
        self._add_image_with_layers("environment:tag1", [("layerA", 1000), ("layerB", 2000), ("layerC", 3000)])
        self._add_image_with_layers("environment:tag2", [("layerA", 1000), ("layerB", 2000), ("layerD", 4000)])
        self._add_image_with_layers("environment:tag3", [("layerA", 1000), ("layerE", 5000)])
    ...
    def test_nonexistent_image(self):
        ...
        self._add_image_with_layers("environment:tag1", [("layer1", 1000)])
    ...
    def test_complex_scenario(self):
        ...
        self._add_image_with_layers("environment:tag1", [("layerA", 1000), ("layerB", 2000), ("layerC", 3000)])
        self._add_image_with_layers("environment:tag2", [("layerA", 1000), ("layerB", 2000), ("layerD", 4000)])
        self._add_image_with_layers("environment:tag3", [("layerA", 1000), ("layerC", 3000), ("layerE", 5000)])
        self._add_image_with_layers("environment:tag4", [("layerF", 6000), ("layerG", 7000)])
...
class TestSharedLayerCalculationWithRealisticData:
    ...
    def test_ref_count_tracking(self):
        ...
        analyzer.images["environment:tag1"] = {
            "repository": "test-repo/environment",
            "tag": "tag1",
            "digest": "sha256:img1",
        }
        ...
        analyzer.images["environment:tag2"] = {
            "repository": "test-repo/environment",
            "tag": "tag2",
            "digest": "sha256:img2",
        }
    ...
    def test_layer_order_preservation(self):
        ...
        for order_index, (layer_id, size) in enumerate(layers):
            ...
            analyzer.image_layers.append({"image_id": image_id, "layer_id": layer_id, "order_index": order_index})
