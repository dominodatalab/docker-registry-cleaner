...
class TestDeletionWorkflows:
    ...
    def sample_image_analysis(self):
        ...
        return {
            "layer1": {"tags": ["env:tag1", "env:tag2", "env:tag3"], "size": 1000000},
            "layer2": {"tags": ["model:tag4"], "size": 2000000},
        }
    ...
    def sample_mongodb_reports(self):
        ...
        return {
            "runs": [
                {"environment_docker_tag": "tag1", "last_used": (now - timedelta(days=5)).isoformat() + "Z"},
                {"environment_docker_tag": "tag2", "last_used": (now - timedelta(days=40)).isoformat() + "Z"},  # Old
            ],
            "workspaces": [],
            "models": [],
            "scheduler_jobs": [],
            "projects": [{"environment_docker_tag": "tag3"}],  # In project config
            "organizations": [],
            "app_versions": [],
        }
    ...
    def test_workflow_without_age_filtering(self, deleter, sample_image_analysis, sample_mongodb_reports):
        ...
        analysis = deleter.analyze_image_usage(
            sample_image_analysis, mongodb_reports=sample_mongodb_reports, recent_days=None
        )
    ...
    def test_workflow_with_age_filtering(self, deleter, sample_image_analysis, sample_mongodb_reports):
        ...
        analysis = deleter.analyze_image_usage(
            sample_image_analysis, mongodb_reports=sample_mongodb_reports, recent_days=30
        )
    ...
    def test_generate_deletion_report(self, deleter):
        ...
        analysis = WorkloadAnalysis(
            ...
            image_usage_stats={
                "tag3": {"size": 500000000, "status": "unused", "usage": {}},
                "tag4": {"size": 500000000, "status": "unused", "usage": {}},
            },
        )
